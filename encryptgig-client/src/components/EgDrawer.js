  ...
  return (
    <Fragment>
      <Router>
        ...
        >
          <div className={classes.toolbar}> <img src={process.env.PUBLIC_URL + 'icons/Encryptgig_logo.png'} alt="EncryptGig Logo" width="240" height="64"/ > </div>
          <Divider />
          <List>
            ...
            >
              <ListItemIcon>   
              <InsertDriveFileIcon style={{ fontSize: 19 }}></InsertDriveFileIcon>
            </ListItemIcon>
